...
{
    /// <summary>
    /// A generic base view which can take on various form factors and styles.
    /// </summary>
    public class UIButton : UITextView
    {
        /// <summary>
        /// Initialise a new base from a string.
        /// </summary>
        ...
        /// <summary>
        /// If the base is currently pressed.
        /// </summary>
        public bool Pressed { get; private set; } = false;

        /// <summary>
        /// If the base is checkable.
        /// </summary>
        ...
        /// <summary>
        /// If the base allows being unchecked.
        /// </summary>
        public bool AllowUnchecking { get; set; } = true;

        /// <summary>
        /// If the base is checked.
        /// </summary>
        public bool Checked
        {
            get => _checked;
        ...
        /// <summary>
        /// Fired when the checked state of the base changes.
        /// </summary>
