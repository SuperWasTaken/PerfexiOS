...
{
    /// <summary>
    /// A modified version of the UItextView class designed just for taking input on a single line 
    /// </summary>
    public class UIinput: UIView
    {
        ...
        public UIinput(TextStyle style)
        {
        ...
        public UIinput(TextBlock textBlock)
        {
            Content = textBlock;
            _renderer = new TextRenderer();
            Content.OnChanged.Bind(HandleTextBlockChange);
        ...
        /// <summary>
        /// This bool controls if you can add new lines or not with enter when true  it will just return instead of creating a new line in 
        /// the text view 
        /// </summary>
        ...
        public readonly Signal<SignalArgs> OnInput = new();
    }
}
