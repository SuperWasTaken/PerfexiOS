...
namespace Mirage.DE
{
    ...
    class OOBE : UIApplication
    {
        ...
        {
            MainWindow = new UIWindow(surfaceManager, 480, 360, "Perfexi OS HardChair1", resizable: false);
            ...
            TextBlock headerBlock = new TextBlock(new TextStyle(Resources.comicSans, Color.Black));
            headerBlock.Append("HELLO!\n");
            headerBlock.Append("Welcome to Perfexi OS please\n");
            headerBlock.Style = new TextStyle(Resources.comicSans, Color.DeepGray);
