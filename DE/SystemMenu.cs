...
using PerfexiOS.DE;
using PERFEXIOS.DE;
using PERFEXIOS.DE.DiskPart;
using PERFEXIOS.PerfexiOSMirage.Mirage_beta_1._0.Mirage_beta_1._0.src.DE;
...
namespace Mirage.DE
{
    ...
    public class SystemMenu
    {
        ...
        public SystemMenu(SurfaceManager surfaceManager)
        {
            ...
            UIButton button = new UIButton("PerfexiOS")
            {
                Location = new(8, 0),
            ...
            UIContextMenu contextMenu = new UIContextMenu(new()
            {
                new()
                {
                    ...
                    new("Files", () => _ = new EXPLORER(surfaceManager)),
                    new("Scrolltest",() => new Scrollbartest(surfaceManager)),
                    new("DiskPart",()=> _ = new DiskPart(surfaceManager)),
