...
{
    /// <summary>
    /// A base in a surface's title bar.
    /// </summary>
    public class TitleBarButton
    {
        /// <summary>
        /// Initialise a new title bar base.
        /// </summary>
        ...
        /// <summary>
        /// The callback that will be called when the base is pressed.
        /// </summary>
        public Action Callback;

        /// <summary>
        /// The X coordinate of the title bar base.
        /// </summary>
        public int X;

        /// <summary>
        /// The Y coordinate of the title bar base.
        /// </summary>
        public int Y;

        /// <summary>
        /// The width of the title bar base.
        /// </summary>
        public int Width => _image.Width;

        /// <summary>
        /// The Height of the title bar base.
        /// </summary>
        public int Height => _image.Height;

        /// <summary>
        /// If the base is pressed.
        /// </summary>
        public bool Hovered;
