...
namespace Mirage.SurfaceKit
{
    ...
    public class TitleBar
    {
        ...
        public TitleBar(Surface surface)
        {
            ...
            _bases.Add(new TitleBarButton(Resources.Close, Resources.Close_Hover, Resources.Close_Press, CloseButtonClicked));
            if (_surface.Resizable)
            {
                _bases.Add(new TitleBarButton(Resources.Max, Resources.Max_Hover, Resources.Max_Press, () => {}));
                _bases.Add(new TitleBarButton(Resources.Min, Resources.Min_Hover, Resources.Min_Press, () => {}));
            }
            LayOutButtons();
        ...
        /// <summary>
        /// Handle the close base of the title bar being clicked.
        /// </summary>
        ...
        private void LayOutButtons()
        {
            ...
            {
                TitleBarButton button = _bases[i];
                x -= button.Width;
                button.X = x;
        ...
        /// <summary>
        /// Paint the title bar's bases.
        /// </summary>
        private void PaintButtons()
        {
            foreach (TitleBarButton button in _bases)
            {
        ...
        /// </summary>
        /// <param name="base">The base whose state should be updated.</param>
        /// <param name="base">Whether to repaint the titlebar's content area if the state changes.</param>
        ...
        /// <summary>
        /// Update the state of the titlebar's bases.
        /// </summary>
        ...
        /// <summary>
        /// Get the rectangle of a title bar base, relative to the screen.
        /// </summary>
        /// <param name="base">The button.</param>
        /// <returns>The rectangle of the base, relative to the screen.</returns>
        ...
        public void HandlePress(SurfaceManager surfaceManager)
        {
            ...
            foreach (TitleBarButton button in _bases)
            {
                ...
                {
                    Rectangle baseScreenRect = GetButtonScreenRect(button);
                    TitleBarButtonOperation operation = new TitleBarButtonOperation(surfaceManager, this, button, baseScreenRect);
        ...
        /// <summary>
        /// The spacing between bases in the title bar.
        /// </summary>
        private const int BUTTON_SPACING = 2;

        /// <summary>
        /// The title bar's bases.
        /// </summary>
        private readonly List<TitleBarButton> _bases = new List<TitleBarButton>();
